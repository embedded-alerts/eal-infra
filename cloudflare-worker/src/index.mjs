...
const PRODUCT = Object.freeze({
  ...
  tagline: 'Embedding-first monitoring and alert matching for the signals that actually matter.',
  audience: 'operators, analysts, researchers, support teams, developers, and intelligence workflows',
  integrations: ['RSS/Atom', 'Webhooks', 'Email ingest', 'Slack', 'Search APIs', 'Vector databases'],
  capabilities: ['signals', 'subscriptions', 'vector-matching', 'events', 'alerts', 'audit'],
});
