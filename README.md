...
Kubernetes, Argo CD, observability, and bounded Cloudflare Worker edge code for Embedded Alerts.

Initialized through `DEN-1949` as a testable `infra` foundation. Product behavior continues through focused pull requests.
